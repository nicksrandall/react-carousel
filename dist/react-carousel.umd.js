(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('prop-types/checkPropTypes'), require('prop-types')) :
	typeof define === 'function' && define.amd ? define(['prop-types/checkPropTypes', 'prop-types'], factory) :
	(global.ReactCarousel = factory(global.checkPropTypes,global.PropTypes));
}(this, (function (checkPropTypes,PropTypes) { 'use strict';

checkPropTypes = checkPropTypes && checkPropTypes.hasOwnProperty('default') ? checkPropTypes['default'] : checkPropTypes;
...
function validatePropTypes(element) {
  ...
  if (propTypes) {
    currentlyValidatingElement = element;
    checkPropTypes$$1(propTypes, element.props, 'prop', name, getStackAddendum);
    currentlyValidatingElement = null;
...
//# sourceMappingURL=react-carousel.umd.js.map
